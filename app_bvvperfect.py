...
if st.session_state.df is None:
    ...
    if page == "📋 Data View":
        ...
        if not KEYBOARD_AUTOMATION_AVAILABLE:
            ...
            st.info("This feature will use Ctrl+Tab to switch to PayAByPhone tab and fill in card details from your data.")
            ...
            if number_col is None:
                ...
                available_numbers = df[number_col].dropna().astype(str).str.strip()  # type: ignore
                available_numbers = available_numbers[available_numbers != ''].unique()  # type: ignore
                    ...
                    if st.button("🚀 Test Card", type="primary"):
                        with st.spinner("Switching to PayAByPhone tab and filling form..."):
                            try:
                                ...
                                elif selected_number:  # Fallback to the selected number
                                    values_to_fill.append(str(selected_number))
                                ...
                                st.success(f"✅ Card number '{selected_number}' and {filled_fields} other field(s) have been filled in!")
